...
public enum ErrorCode {
	...
	NOTIFICATION_VALIDATION_FAILED(HttpStatus.BAD_REQUEST, "알림 생성 검증에 실패했습니다."),
	...
	MATCH_PROPOSAL_REJECTED_BY_OPPONENT(HttpStatus.CONFLICT, "상대방이 이미 매칭 제안을 거절했습니다."),
	MATCH_PROPOSAL_ALREADY_DECIDED(HttpStatus.CONFLICT, "이미 해당 매칭 제안에 대해 결정을 완료했습니다."),
