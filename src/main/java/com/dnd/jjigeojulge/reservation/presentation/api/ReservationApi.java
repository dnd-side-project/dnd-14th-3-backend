...
public interface ReservationApi {
	@Operation(summary = "Reservation 목록 조회", description = """
	...
	@Operation(summary = "내가 올린 동행 예약 리스트 (호스트)", description = "내가 명시적으로 작성한 동행 모집글의 목록을 조회합니다.")
	@ApiResponses(value = {
	...
	@Operation(summary = "내가 지원한 동행 예약 리스트 (게스트)", description = "내가 게스트로서 지원한 동행 모집글의 목록과 나의 가상 매칭 상태값을 Paging하여 조회합니다.")
	@ApiResponses(value = {
