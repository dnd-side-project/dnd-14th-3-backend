...
class NotificationQueryServiceTest {
        ...
        void getNotifications_returnsPageResponse() {
                ...
                // when
                when(notificationQueryRepository.getNotifications(eq(receiverId), eq(cursor), anyInt()))
                                .thenReturn(mockPage);

                PageResponse<NotificationResponseDto> result = notificationQueryService.getNotifications(receiverId,
                                cursor,
                                limit);
